...
Документация сверена с кодом ветки `main` на коммите
[`9d9678c`](https://github.com/BAITC-Hacks/hack-e4350f2f-astra/commit/9d9678c2ada7ee43d08e7e2327b8f4136969134d).
...
- Сравнение ограничено двумя локальными сценариями. Импорт JSON не реализован.
